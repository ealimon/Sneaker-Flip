          ...
          <div className="flex items-center justify-between h-20 gap-4">
            ...
            <nav className="flex-1 min-w-0 flex items-center justify-end gap-2 overflow-x-auto py-2.5 px-1 scrollbar-thin" aria-label="Main Navigation">
              <button
                ...
                type="button"
                onClick={() => setCurrentView('storybook')}
                className={`flex items-center gap-1.5 px-3.5 py-2 border-2 border-slate-900 text-xs font-black uppercase tracking-wider transition whitespace-nowrap cursor-pointer ${
